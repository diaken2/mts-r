...
export default function PrivacyPage({cityName}:any) {
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">1. Общие положения</h2>
              <div className="space-y-4 text-gray-650">
                ...
                <p>1.3. Политика применяется ко всей информации, которую Оператор может получить о посетителях сайта <a href="https://home-mts.ru" className="text-orange-500 hover:underline">https://home-mts.ru</a> (далее — Сайт), а также о клиентах в процессе взаимодействия с Оператором, включая устные и письменные коммуникации.</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">2. Термины</h2>
              <div className="space-y-3 text-gray-650">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">3. Принципы обработки персональных данных</h2>
              <p className="text-gray-650 mb-3">Оператор обрабатывает персональные данные на основании следующих принципов:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-650 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">4. Цели обработки персональных данных</h2>
              <div className="space-y-4 text-gray-650">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">5. Объем обрабатываемых данных</h2>
              <p className="text-gray-650 mb-3">Персональные данные, которые могут быть обработаны:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-650 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">6. Условия обработки и передачи данных</h2>
              <div className="space-y-4 text-gray-650">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">7. Права субъекта персональных данных</h2>
              <p className="text-gray-650 mb-3">Пользователь имеет право:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-650 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">8. Обязанности Оператора</h2>
              <p className="text-gray-650 mb-3">Оператор обязан:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-650 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">9. Уничтожение персональных данных</h2>
              <p className="text-gray-650 mb-3">Уничтожение персональных данных осуществляется:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-650 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">10. Хранение персональных данных</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">11. Контакты и порядок обращений</h2>
              <div className="space-y-4 text-gray-650">
                <p>11.1. Запросы по вопросам обработки персональных данных можно направить:</p>
                <p className="ml-4">
                  на электронную почту: <a href="mailto:partner@home-mts.ru" className="text-orange-500 hover:underline font-medium">partner@home-mts.ru</a>
                </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-750 mb-4">12. Прочие положения</h2>
              <div className="space-y-4 text-gray-650">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 text-center">
            <Link 
              href="/order" 
              className="inline-flex items-center px-6 py-3 bg-mts-red hover:bg-mts-red-dark text-white font-medium rounded-lg transition-colors"
            >
