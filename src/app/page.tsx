...
import GeoRedirect from "@/components/blocks/GeoDirect";
...
export async function generateMetadata() {
  return {
    title: "МТС — тарифы и подключение интернета и ТВ в России",
    description: "Подключение МТС в вашем городе. Действующие тарифы на услуги МТС в России. Оставьте заявку на сайте.",
    openGraph: {
      title: "МТС — тарифы и подключение интернета и ТВ в России",
      description: "Подключение МТС в вашем городе. Действующие тарифы на услуги МТС в России. Оставьте заявку на сайте.",
    },
...
async function getDefaultCity(): Promise<{ slug: string; name: string }> {
  try {
    ...
    // Проверяем, есть ли тарифы для первого доступного города
    ...
    // Если ни один город не имеет тарифов, возвращаем дефолт
