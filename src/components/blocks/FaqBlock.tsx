...
const FaqBlock = () => {
  ...
  const faq = [
    ...
    },
    {
      ...
      answer: (
        <>
          МТС предоставляет полный спектр телекоммуникационных услуг, включая скоростной интернет от 100 до 1024 Мбит/с Мбит/с и телевидение до 220 каналов. Вы можете выбрать подходящий тарифный план, который будет соответствовать вашим требованиям и бюджету.
        </>
      ),
      icon: "🎯"
    },
