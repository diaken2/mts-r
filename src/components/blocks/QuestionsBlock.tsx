            ...
            <div className="flex-1 flex flex-col justify-start items-stretch p-8 md:p-12 order-2 md:order-none">
              <div className="w-full max-w-2xl h-full flex flex-col justify-center">
                <div className="flex flex-col justify-center h-full animate-fade-in" data-support-info>
                  <h2 className="text-2xl md:text-3xl font-bold mb-2 text-left">Вы являетесь действующим абонентом МТС</h2>
            ...
            <div className="w-full max-w-2xl h-full flex flex-col justify-start">
              {!(showSupportInfo || showOtherForm) ? (
                <>
                  ...
                  <span className="text-base font-normal text-gray-400 mb-3 block text-left">Выберите вариант обращения</span>
                    ...
                    {categories.map((cat) => (
                      <button
                        ...
                        className={`
                          ...
                          ${category === cat.key
                            ? "bg-[#ee3c6b] border-[#ee3c6b] text-white"
                            : "border-[#ee3c6b] text-[#ee3c6b] bg-white"}
                        `}
                        onClick={() => {
                          setCategory(cat.key);
                          setSupportValue(null);
                        ...
                        <label key={opt} className="flex items-start cursor-pointer select-none">
                          <span
                            className={`
                              ...
                              ${otherValue === opt ? "border-[#ee3c6b] bg-[#ee3c6b]" : "border-gray-300 bg-white"}
                            `}
                          >
                            {otherValue === opt && (
                  ...
                  {category === "connection" && (
                    <form className="flex flex-col gap-4 animate-fade-in" autoComplete="off" onSubmit={handleSubmit}>
                          ...
                          <label key={type} className="flex items-center cursor-pointer select-none flex-shrink-0">
                            <span
                              className={`
                                ...
                                ${houseType === type ? "border-[#ee3c6b] bg-[#ee3c6b]" : "border-gray-300 bg-white"}
                              `}
                            >
                              {houseType === type && (
                                <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
                            ...
                            <input
                              ...
                              className="hidden"
                            />
                            <span className={`text-xs md:text-base font-medium ${houseType === type ? "text-[#ee3c6b]" : "text-gray-700"} break-words text-left`}>
                              {type}
                            </span>
                          </label>
                        ))}
                      ...
                      <div className="flex flex-col md:flex-row gap-4 items-end w-full">
                        <div className="w-full md:flex-1">
                          ...
                          <div className="flex items-center rounded-full border border-gray-300 bg-white overflow-hidden w-full">
                            <span className="px-4 py-3 text-base text-[#ee3c6b] bg-[#f5f7fa] font-medium">+7</span>
                            <InputMask
                              mask="(999) 999-99-99"
                              value={phone}
                              ...
                              <button
                                ...
                                className={`w-full px-4 py-2 text-left text-sm transition-colors ${
                                  selectedTime === slot.value 
                                    ? 'bg-[#fff1f4] text-[#ee3c6b] font-semibold' 
                      ...
                      <p className="text-xs text-gray-400 mt-2 text-right">
                        Отправляя заявку, вы соглашаетесь с <Link href="/privacy" className="underline text-[#ee3c6b]">политикой обработки данных</Link>
                      </p>
                    </form>
                  )}
                </>
